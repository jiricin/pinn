...
class PINN:
    ...
    def evaluate_transition_dx(self, model, x, y):
        output = self.evaluate(model, x, y)
    ...
    def closure(self):
        ...
        pred_t_dx_L = self.evaluate_transition_dx(self.model_L, self.t_loc_x, self.t_loc_y)
        ...
        pred_t_dx_R = self.evaluate_transition_dx(self.model_R, self.t_loc_x, self.t_loc_y)
    ...
    def plot_transition_dx_loss_hist(self, title, filename):
        values_L = self.evaluate_transition_dx(self.model_L, self.t_loc_x, self.t_loc_y).detach().numpy().reshape(-1)
        values_R = self.evaluate_transition_dx(self.model_R, self.t_loc_x, self.t_loc_y).detach().numpy().reshape(-1)
...
if __name__ == '__main__':
    ...
    n_samples_L_1 = dg_func(func, n_loc_L_1[0], n_loc_L_1[1], a, b, n_dir_L_1[0], n_dir_L_1[1])
    n_samples_L_2 = dg_func(func, n_loc_L_2[0], n_loc_L_2[1], a, b, n_dir_L_2[0], n_dir_L_2[1])
    ...
    n_samples_R_1 = dg_func(func, n_loc_R_1[0], n_loc_R_1[1], a, b, n_dir_R_1[0], n_dir_R_1[1])
    n_samples_R_2 = dg_func(func, n_loc_R_2[0], n_loc_R_2[1], a, b, n_dir_R_2[0], n_dir_R_2[1])
    ...
    xx_L = xx_L.reshape(-1)
    yy_L = yy_L.reshape(-1)
    orig_L = g_func(func, xx_L, yy_L, a, b)
    ...
    xx_R = xx_R.reshape(-1)
    yy_R = yy_R.reshape(-1)
    orig_R = g_func(func, xx_R, yy_R, a, b)
    loc_R = np.array([xx_R, yy_R])

    # visualize results
    pinn.plot_trained_function('Trained function', 'task_2A_' + str(func) + '_function.png', loc_L, loc_R)
    pinn.plot_error('Error', 'task_2A_' + str(func) + '_error.png', loc_L, loc_R, orig_L, orig_R)
    pinn.plot_error_hist('Error', 'task_2A_' + str(func) + '_errorh.png', loc_L, loc_R, orig_L, orig_R)

    pinn.plot_equation_loss('Equation loss', 'task_2A_' + str(func) + '_pde_loss.png')
    pinn.plot_equation_loss_hist('Equation loss', 'task_2A_' + str(func) + '_loss_eqh.png')
    pinn.plot_equation_loss_hist_L('Equation loss (L)', 'task_2A_' + str(func) + '_loss_eqh_L.png')
    pinn.plot_equation_loss_hist_R('Equation loss (R)', 'task_2A_' + str(func) + '_loss_eqh_R.png')
    pinn.plot_dirichlet_loss_hist('Dirichlet loss', 'task_2A_' + str(func) + '_loss_dh.png')
    pinn.plot_dirichlet_loss_hist_L('Dirichlet loss (L)', 'task_2A_' + str(func) + '_loss_dh_L.png')
    pinn.plot_dirichlet_loss_hist_R('Dirichlet loss (R)', 'task_2A_' + str(func) + '_loss_dh_R.png')
    pinn.plot_neumann_loss_hist('Neumann loss', 'task_2A_' + str(func) + '_loss_nh.png')
    pinn.plot_neumann_loss_hist_L('Neumann loss (L)', 'task_2A_' + str(func) + '_loss_nh_L.png')
    pinn.plot_neumann_loss_hist_R('Neumann loss (R)', 'task_2A_' + str(func) + '_loss_nh_R.png')
    pinn.plot_transition_loss_hist('Transition loss', 'task_2A_' + str(func) + '_loss_th.png')
    pinn.plot_transition_dx_loss_hist('Transition differential loss', 'task_2A_' + str(func) + '_loss_tdh.png')

    pinn.plot_loss_history_all_L('Loss history (L)', 'task_2A_' + str(func) + '_loss_history_L_all.png')
    pinn.plot_loss_history_all_R('Loss history (R)', 'task_2A_' + str(func) + '_loss_history_R_all.png')
    pinn.plot_loss_history_all_t('Loss history (R)', 'task_2A_' + str(func) + '_loss_history_t_all.png')
