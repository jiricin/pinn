...
class PINN:
    ...
    def closure(self):
        ...
        transition_dx_prediction_L = self.evaluate_transition_dx(self.model_L, self.transition_x, self.transition_y)
        ...
        transition_dx_prediction_R = self.evaluate_transition_dx(self.model_R, self.transition_x, self.transition_y)
...
if __name__ == '__main__':
    ...
    # create PINN
    pinn = PINN(i_loc_L, d_loc_L, d_samples_L, i_loc_R, d_loc_R, d_samples_R, t_loc)
