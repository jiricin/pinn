...
class PINN:
    ...
    def closure(self):
        ...
        equation_prediction_L = self.evaluate_equation(self.model_L, self.loc_x_L, self.loc_y_L)
        ...
        transition_dx_prediction_L = self.evaluate_transition_dx(self.model_L, self.transition_x, self.transition_y, self.transition_dir_x, self.transition_dir_y)
        equation_prediction_R = self.evaluate_equation(self.model_R, self.loc_x_R, self.loc_y_R)
        ...
        transition_dx_prediction_R = self.evaluate_transition_dx(self.model_R, self.transition_x, self.transition_y, self.transition_dir_x, self.transition_dir_y)
...
if __name__ == '__main__':
    ...
    # create PINN
    pinn = PINN(i_loc_L, d_loc_L, d_samples_L, i_loc_R, d_loc_R, d_samples_R, t_loc, t_direction)
